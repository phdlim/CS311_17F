...
typedef struct CPU_State_Struct {
	...
	uint32_t IF_ID_INST;
	uint32_t IF_ID_NPC;
    uint32_t IF_ID_OPCODE;
    uint32_t IF_ID_FUNC;
    uint32_t IF_ID_RS;
    uint32_t IF_ID_RT;
    uint32_t IF_ID_RD;
    uint32_t IF_ID_SHAMT;
    short IF_ID_IMM;
    uint32_t IF_ID_TARGET;


    //NOT latch
    uint32_t IF_STALL_PC;
	...
	uint32_t ID_EX_IMM;
    unsigned char ID_EX_R1;
    unsigned char ID_EX_R2;
    unsigned char ID_EX_RT;
    unsigned char ID_EX_RD;


    //NOT latch
    uint32_t ID_JMP_ADDR;
    unsigned char ID_JMP_TAKE;
    ...
    uint32_t MEM_WB_MEM_TAKE;
    uint32_t MEM_WB_MEM_READ;
